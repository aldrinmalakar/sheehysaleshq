...
var css=[
  ...
  'html[data-shq-theme="monokai"] .channel-chip,html[data-shq-theme="monokai"] .status-pill,html[data-shq-theme="monokai"] .funnel-jump-nav a,html[data-shq-theme="monokai"] .outcome-btn,html[data-shq-theme="monokai"] .mini-btn{background:#272822!important;border-color:#5a5b50!important;color:#d7d7cf!important}',
  'html[data-shq-theme="monokai"] .channel-chip.on[data-channel="phone"],html[data-shq-theme="monokai"] .status-pill.good,html[data-shq-theme="monokai"] .outcome-btn.success{background:#28301f!important;border-color:#59762a!important;color:#a6e22e!important}',
  ...
  'html[data-shq-theme="monokai"] .status-pill.blue,html[data-shq-theme="monokai"] .next-action{background:#253239!important;border-color:#3f6872!important;color:#dff9ff!important}',
  'html[data-shq-theme="monokai"] .status-pill.warn,html[data-shq-theme="monokai"] .outcome-btn.warn{background:#332b1d!important;border-color:#79591f!important;color:#fdc76d!important}',
  ...
  'html[data-shq-theme="monokai"] .sub,html[data-shq-theme="monokai"] .note,html[data-shq-theme="monokai"] .cue,html[data-shq-theme="monokai"] .meta,html[data-shq-theme="monokai"] .foot,html[data-shq-theme="monokai"] .agehint,html[data-shq-theme="monokai"] .quiet,html[data-shq-theme="monokai"] .po span,html[data-shq-theme="monokai"] .attempt-status,html[data-shq-theme="monokai"] .next-action p{color:#b7b7ae!important}',
  ...
  'html[data-shq-theme="monokai"] .cpy:hover,html[data-shq-theme="monokai"] .copy-btn:hover,html[data-shq-theme="monokai"] .ghostb:hover,html[data-shq-theme="monokai"] .qbtn:hover,html[data-shq-theme="monokai"] .chip:hover,html[data-shq-theme="monokai"] .funnel-jump-nav a:hover,html[data-shq-theme="monokai"] .outcome-btn:hover:not(:disabled){border-color:#66d9ef!important;color:#66d9ef!important}',
