...
function ensureStyle(){
  ...
  var css=[
    ...
    'html[data-shq-theme="night"] .panel,html[data-shq-theme="night"] .card,html[data-shq-theme="night"] .script-card,html[data-shq-theme="night"] .weight,html[data-shq-theme="night"] .timing,html[data-shq-theme="night"] .confirmbox,html[data-shq-theme="night"] .confline,html[data-shq-theme="night"] .line,html[data-shq-theme="night"] .appt{background-color:#272822!important;border-color:#4b4c45!important;color:#f8f8f2!important}',
    'html[data-shq-theme="night"] .context-box,html[data-shq-theme="night"] .script-body,html[data-shq-theme="night"] .po,html[data-shq-theme="night"] .companion,html[data-shq-theme="night"] details.attempts,html[data-shq-theme="night"] details.contact-history,html[data-shq-theme="night"] .contact-metric,html[data-shq-theme="night"] .attempt-status{background:#20211e!important;border-color:#4b4c45!important;color:#f8f8f2!important}',
    'html[data-shq-theme="night"] .contact-control,html[data-shq-theme="night"] .video-panel{background:#272822!important}',
    'html[data-shq-theme="night"] .funnel-jump-nav a,html[data-shq-theme="night"] .channel-chip,html[data-shq-theme="night"] .status-pill,html[data-shq-theme="night"] .mini-btn,html[data-shq-theme="night"] .outcome-btn,html[data-shq-theme="night"] .qbtn,html[data-shq-theme="night"] .ghostb,html[data-shq-theme="night"] .cpy{background:#30312c!important;color:#d7d8cf!important;border-color:#4b4c45!important}',
    'html[data-shq-theme="night"] .funnel-jump-nav a:hover,html[data-shq-theme="night"] .channel-chip:hover,html[data-shq-theme="night"] .mini-btn:hover,html[data-shq-theme="night"] .outcome-btn:hover:not(:disabled){color:#66d9ef!important;border-color:#66d9ef!important}',
    'html[data-shq-theme="night"] .channel-chip.on[data-channel="phone"],html[data-shq-theme="night"] .outcome-btn.success{background:#28351f!important;border-color:#6f8f32!important;color:#c9f27d!important}',
    ...
    'html[data-shq-theme="night"] .status-pill.warn,html[data-shq-theme="night"] .outcome-btn.warn{background:#3a3020!important;border-color:#8f6a2d!important;color:#ffd27a!important}',
    'html[data-shq-theme="night"] .status-pill.blue{background:#24333a!important;border-color:#3f7280!important;color:#8ce9f8!important}',
    ...
    'html[data-shq-theme="night"] .warn,html[data-shq-theme="night"] .flag{background:#3a3020!important;border-color:#8f6a2d!important;color:#ffd27a!important}',
    'html[data-shq-theme="night"] .stop,html[data-shq-theme="night"] .empty-channels{background:#3a2028!important;border-color:#8c3f5a!important;color:#ff9ab7!important}',
    ...
    'html[data-shq-theme="night"] .po span,html[data-shq-theme="night"] .quiet,html[data-shq-theme="night"] .note,html[data-shq-theme="night"] .sub,html[data-shq-theme="night"] .meta{color:#b6b7ad!important}',
